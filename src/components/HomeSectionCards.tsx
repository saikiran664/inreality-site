...
const CARDS: Card[] = [
  {
    ...
    blurb:
      "Eleven services under one roof, check out our end-to-end services for shaping your digital presence into a prominent, recognisable brand that stands out in a crowded digital world.",
